...
INSERT INTO `chuyendi` VALUES ('1','2021-04-16 00:00:00','TpHCM','Bến Tre ',29,0,200000,'17:12:00','GHE_01'),('313220','2022-04-15 00:00:00','TpHCM','Bến Tre ',23,6,200000,'17:12:00','GHE_01'),('355727','2022-04-12 00:00:00','Bến Tre','TpHCM',24,0,200000,'09:30:00','GHE_02'),('363366','2023-01-10 00:00:00','Bến Tre ','TpHCM',24,0,200000,'12:20:00','GHE_02'),('612320','2022-04-12 00:00:00','Bến Tre','TpHCM',24,0,200000,'09:30:00','GHE_02');
...
CREATE TABLE `doanhthuchuyendi` (
  ...
  `MaChuyenDi` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  KEY `fk_doanhthuchuyendi_chuyendi1_idx` (`MaChuyenDi`),
  CONSTRAINT `fk_doanhthuchuyendi_chuyendi1` FOREIGN KEY (`MaChuyenDi`) REFERENCES `chuyendi` (`MaChuyenDi`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `doanhthuchuyendi` VALUES (1,NULL,NULL,''),(2,NULL,NULL,''),(355727,600000,'0000-00-00 00:00:00','2022-01-03 00:00:00'),(678116,200000,'0000-00-00 00:00:00','2022-01-03 00:00:00'),(200000,1,'2022-01-06 00:00:00','355727'),(200000,1,'2022-01-06 00:00:00','313220');
...
INSERT INTO `vexe` VALUES ('229022','0123456789','0123456789','2022-01-06 00:00:00','A3','Đặt','313220','1'),('437604','0123456789','0123456789','2022-01-06 00:00:00','A7','Đặt','313220','2'),('562190','0123456789','0123456789','2022-01-06 00:00:00','A6','Đặt','313220','2'),('815685','0123456789','0123456789','2022-01-06 00:00:00','A1','Bán','313220','1'),('851519','0123456789','0123456789','2022-01-06 00:00:00','A2','Đặt','313220','1'),('867355','0123456789','0123456789','2022-01-06 00:00:00','A4','Đặt','313220','1');
...
-- Dump completed on 2022-01-06 15:22:06
